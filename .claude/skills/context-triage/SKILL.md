...
1. Read repository instructions first: `AGENTS.md`, `CLAUDE.md`, or equivalents.
...
Stop triage when you can name the likely files to change and the verification command.
